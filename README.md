...
<html>
    <head>
        <meta charset="UTF-8"/>
        <link rel ="stylesheet" href="BMFW.css" id="norm">
        <link rel="alternate" href="ModePsychedelique.css" id="psych">
        <titre>BetterMotherFuckingWebsite</titre>
    </head>
    <body>
        
        <button id="boutonStyle" onclick="switchStylesheet()">Mode Psychedelique</button>
        ...
        <script> 
                function popup(){
                    if(confirm("Hey, le site xxxvidsxxx est trop bien. Tu veux mater ?")) {
                ...
                function switchStylesheet() {
                    var cssNormal = document.getElementById("norm"), cssPsyche = document.getElementById("psych"), txtBouton = document.getElementById("boutonStyle");
                    if ((cssNormal.rel == "stylesheet") && (cssPsyche.rel == "alternate")) {
                        cssNormal.rel = "alternate";
                        cssPsyche.rel = "stylesheet";
                        txtBouton.innerHTML = "Retour au Mode Triste";
                    }

                    else {
                        cssNormal.rel = "stylesheet";
                        cssPsyche.rel = "alternate";
                        txtBouton.innerHTML = "Mode Psychedelique";
                    }
